...
with col1:
    st.image("image/Black And White Modern Typographic Simple social Media logo.png", width=300)
...
with col2:
    ...
    st.markdown(
        ...
        <ol>
            <li style='color: #000080; font-size: {font_size_answers}px;'>User Distribution and Addiction Level Analysis</a></li>
            <li style='color: #000080; font-size: {font_size_answers}px;'>Analysis of Time Spent over Social Media</a></li>
        </ol>
